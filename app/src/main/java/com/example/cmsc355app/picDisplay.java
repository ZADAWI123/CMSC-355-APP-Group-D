...
//        String programPicInt = PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getString("programImageInt", "");
//        String programPicHard = PreferenceManager.getDefaultSharedPreferences(getBaseContext()).getString("programImageHard", "");
...
//        List<String> hardList = Arrays.asList(programPicHard.split("\\s*,\\s*"));
        ...
        //Iterator itr = exerciseImages.iterator();
            //if (exerciseImages==(firstImage)){
